...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: Converter</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: Converter</h1>
...
<header>
        ...
        Converter
            ...
            <div class="class-description">An abstract type for converters, objects that can convert and
optionally revert values between domains, like strings and numbers.</div>
...
<article>
    ...
    <h4 class="name" id="Converter"><span class="type-signature"></span>new Converter<span class="signature">()</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="core_converter_converter.js.html">core/converter/converter.js</a>, <a href="core_converter_converter.js.html#line65">line 65</a>
    </li></ul></dd>
