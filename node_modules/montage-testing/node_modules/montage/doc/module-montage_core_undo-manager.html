...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Module: montage/core/undo-manager</title>
...
<div id="main">
    ...
    <h1 class="page-title">Module: montage/core/undo-manager</h1>
...
<h4 class="name" id="~UndoManager"><span class="type-signature">(inner) </span>UndoManager<span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="core_undo-manager.js.html">core/undo-manager.js</a>, <a href="core_undo-manager.js.html#line136">line 136</a>
    </li></ul></dd>
