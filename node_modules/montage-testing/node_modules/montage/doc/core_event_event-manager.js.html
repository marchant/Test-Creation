...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: core/event/event-manager.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: core/event/event-manager.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>/*global Window, Document, Element, Event, Components, Touch, MontageElement */
