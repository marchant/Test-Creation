...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="core_serialization_serializer_montage-ast.js.html">core/serialization/serializer/montage-ast.js</a>, <a href="core_serialization_serializer_montage-ast.js.html#line144">line 144</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="core_module-reference.js.html">core/module-reference.js</a>, <a href="core_module-reference.js.html#line29">line 29</a>
    </li></ul></dd>
...
<h4 class="name" id="require"><span class="type-signature"></span>require<span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="core_module-reference.js.html">core/module-reference.js</a>, <a href="core_module-reference.js.html#line37">line 37</a>
    </li></ul></dd>
    ...
    <h4 class="name" id="resolve"><span class="type-signature"></span>resolve<span class="signature">(otherRequire)</span><span class="type-signature"> &rarr; {string}</span></h4>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>otherRequire</code></td>
...
<span class="param-type">function</span>
            ...
            <td class="description last">Require from another package that has
the package of this module as a dependency.</td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="core_module-reference.js.html">core/module-reference.js</a>, <a href="core_module-reference.js.html#line81">line 81</a>
    </li></ul></dd>
...
<dl>
    <dt>
        ...
        If there is no mapping from this require inside
otherRequire.
        </div>
    </dt>
    <dd></dd>
...
<div class="param-desc">
    The module id to pass to otherRequire that results
in this module.
</div>
...
<span class="param-type">string</span>
    ...
    <pre class="prettyprint"><code>var ref = new ModuleReference().initWithIdAndRequire("core/uuid", montageRequire);
ref.resolve(applicationRequire); // => "montage/core/uuid"</code></pre>

    <pre class="prettyprint"><code>var ref = new ModuleReference().initWithIdAndRequire("ui/main.reel", applicationRequire);
ref.resolve(montageRequire); // => Error
// because there is no module id such that montageRequire(id) can
// return the module from inside your application</code></pre>
