...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Module: montage/core/extras/date</title>
...
<div id="main">
    ...
    <h1 class="page-title">Module: montage/core/extras/date</h1>
...
<article>
    <div class="container-overview">
            ...
            <div class="description">Defines extensions to intrinsic `Date` object.</div>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="core_extras_date.js.html">core/extras/date.js</a>, <a href="core_extras_date.js.html#line1">line 1</a>
    </li></ul></dd>
    ...
    <dd class="tag-see">
        <ul>
            <li>{<a href="external-Date.html">external:Date</a>}</li>
        </ul>
    </dd>
