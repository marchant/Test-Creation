...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: Montage</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: Montage</h1>
...
<header>
        ...
        <h2>
            <span class="ancestors"><a href="module-montage_core_core.html">montage/core/core</a>~</span>
        
        Montage
        </h2>
        
            <div class="class-description">The basis of all types using the MontageJS framework.</div>
...
<article>
    ...
    <h4 class="name" id="Montage"><span class="type-signature"></span>new Montage<span class="signature">()</span><span class="type-signature"></span></h4>
...
(<a href="Montage.html#.specialize">specialize</a>) and common methods for Montage
prototype chains.
</div>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="core_core.js.html">core/core.js</a>, <a href="core_core.js.html#line69">line 69</a>
    </li></ul></dd>
