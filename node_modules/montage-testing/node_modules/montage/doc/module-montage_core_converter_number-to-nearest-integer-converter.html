...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Module: montage/core/converter/number-to-nearest-integer-converter</title>
...
<div id="main">
    ...
    <h1 class="page-title">Module: montage/core/converter/number-to-nearest-integer-converter</h1>
...
<article>
    <div class="container-overview">
        ...
        <dl>
            <dt><a href="module-montage_core_converter_number-to-nearest-integer-converter-NumberToNearestIntegerConverter.html">NumberToNearestIntegerConverter</a></dt>
            <dd></dd>
        </dl>
