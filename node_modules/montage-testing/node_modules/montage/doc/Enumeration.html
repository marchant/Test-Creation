...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: Enumeration</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: Enumeration</h1>
...
<article>
    ...
    <h4 class="name" id="Enumeration"><span class="type-signature"></span>new Enumeration<span class="signature">()</span><span class="type-signature"></span></h4>
...
<a href="Enumeration.html#.getterFor">getterFor()</a> constructor, as in the following:
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="data_model_enumeration.js.html">data/model/enumeration.js</a>, <a href="data_model_enumeration.js.html#line74">line 74</a>
    </li></ul></dd>
    ...
    <dd class="tag-todo">
        <ul>
            <li>[Charles] Simplify this extremely, notably by making enumerations
instances of the Enumeration class instead of subclasses of it and by
reworking the <a href="Enumeration.html#.getterFor">getterFor()</a> constructor.</li>
        
            <li>[Charles] Switch to initial-caps enumeration value names like "Spades"
instead of all-caps names like "NAMES".</li>
        
            <li>[Charles] Provide a "values" property to the enumeration similar to
Java's "values()" Enum method.</li>
        </ul>
    </dd>
    ...
    <h4 class="name" id=".getterFor"><span class="type-signature">(static) </span>getterFor<span class="signature">(key, uniquePropertyNames<span class="signature-attributes">opt</span>, otherPropertyNames<span class="signature-attributes">opt</span>, prototypeDescriptor<span class="signature-attributes">opt</span>, constructorDescriptor<span class="signature-attributes">opt</span>, constants<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {function}</span></h4>
...
<span class="param-type">string</span>
        ...
        <tr>
                ...
                <td class="name"><code>uniquePropertyNames</code></td>
...
<span class="param-type">string</span>
        ...
        <tr>
                ...
                <td class="name"><code>otherPropertyNames</code></td>
...
<span class="param-type">string</span>
        ...
        <tr>
                ...
                <td class="name"><code>prototypeDescriptor</code></td>
...
<span class="param-type">Object</span>
        ...
        <tr>
                ...
                <td class="name"><code>constructorDescriptor</code></td>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="data_model_enumeration.js.html">data/model/enumeration.js</a>, <a href="data_model_enumeration.js.html#line118">line 118</a>
    </li></ul></dd>
    ...
    <dd class="tag-todo">
        <ul>
            <li>[Charles] Simplify this API, replacing it with simpler
methods like Enumeration.withNames(), Enumeration.withValues(),
and Enumeration.withPrototypeAndValues().</li>
        </ul>
    </dd>
...
<span class="param-type">function</span>
    ...
    <h4 class="name" id=".specialize"><span class="type-signature">(static) </span>specialize<span class="signature">(uniquePropertyNames<span class="signature-attributes">opt</span>, otherPropertyNames<span class="signature-attributes">opt</span>, prototypeDescriptor<span class="signature-attributes">opt</span>, constructorDescriptor<span class="signature-attributes">opt</span>, constants<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {function}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="data_model_enumeration.js.html">data/model/enumeration.js</a>, <a href="data_model_enumeration.js.html#line92">line 92</a>
    </li></ul></dd>
