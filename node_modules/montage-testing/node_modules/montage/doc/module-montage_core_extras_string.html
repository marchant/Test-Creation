...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Module: montage/core/extras/string</title>
...
<div id="main">
    ...
    <h1 class="page-title">Module: montage/core/extras/string</h1>
...
<article>
    <div class="container-overview">
            ...
            <div class="description">Defines extensions to the intrinsic `String` object.</div>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="core_extras_string.js.html">core/extras/string.js</a>, <a href="core_extras_string.js.html#line4">line 4</a>
    </li></ul></dd>
    ...
    <dd class="tag-see">
        <ul>
            <li>{<a href="external-String.html">external:String</a>}</li>
        </ul>
    </dd>
