...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: AbstractToggleSwitch</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: AbstractToggleSwitch</h1>
...
<header>
        ...
        <h2>
            <span class="ancestors"><a href="montage_ui_base_abstract-toggle-switch.module_reel.html">.reel</a>~</span>
        
        AbstractToggleSwitch
        </h2>
...
<article>
    ...
    <h4 class="name" id="AbstractToggleSwitch"><span class="type-signature"></span>new AbstractToggleSwitch<span class="signature">()</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="ui_base_abstract-toggle-switch.js.html">ui/base/abstract-toggle-switch.js</a>, <a href="ui_base_abstract-toggle-switch.js.html#line10">line 10</a>
    </li></ul></dd>
...
<h5>Fires:</h5>
<ul>
    <li>AbstractToggleSwitch#event:action</li>
</ul>
