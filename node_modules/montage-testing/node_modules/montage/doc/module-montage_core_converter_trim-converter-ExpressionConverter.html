...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: ExpressionConverter</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: ExpressionConverter</h1>
...
<header>
        ...
        <h2>
            <span class="ancestors"><a href="module-montage_core_converter_trim-converter.html">montage/core/converter/trim-converter</a>~</span>
        
        ExpressionConverter
        </h2>
        
            <div class="class-description">Uses an expressions to convert and another to revert.</div>
...
<article>
    ...
    <h4 class="name" id="ExpressionConverter"><span class="type-signature"></span>new ExpressionConverter<span class="signature">()</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="core_converter_expression-converter.js.html">core/converter/expression-converter.js</a>, <a href="core_converter_expression-converter.js.html#line10">line 10</a>
    </li></ul></dd>
    ...
    <h5>Example</h5>
        ...
        <p class="code-caption">Returns the value of specific property of an object.</p>
    
    <pre class="prettyprint"><code>var ExpressionConverter = require("./expression-converter").ExpressionConverter,
