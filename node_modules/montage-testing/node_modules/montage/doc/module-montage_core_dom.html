...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Module: montage/core/dom</title>
...
<div id="main">
    ...
    <h1 class="page-title">Module: montage/core/dom</h1>
...
<article>
    <div class="container-overview">
        ...
        <ul>
            <li>module:montage/core/extras/dom</li>
        </ul>
    ...
    <h4 class="name" id="setclassList.jsImplementsacross-browserelement.classListgetter."><span class="type-signature">(inner) </span>external:Element#set
classList.js

Implements a cross-browser element.classList getter.<span class="signature">()</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="core_extras_dom.js.html">core/extras/dom.js</a>, <a href="core_extras_dom.js.html#line83">line 83</a>
    </li></ul></dd>
...
<article>
    <div class="container-overview">
        ...
        <ul>
            <li><a href="module-montage_core_geometry_point.html">module:montage/core/geometry/point</a></li>
        </ul>
