...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: core/extras/string.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: core/extras/string.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>var Map = require("collections/map");
