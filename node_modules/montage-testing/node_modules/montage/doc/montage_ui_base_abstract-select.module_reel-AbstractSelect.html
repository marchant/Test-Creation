...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: AbstractSelect</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: AbstractSelect</h1>
...
<header>
        ...
        <h2>
            <span class="ancestors"><a href="montage_ui_base_abstract-select.module_reel.html">.reel</a>~</span>
...
<article>
    ...
    <h4 class="name" id="AbstractSelect"><span class="type-signature"></span>new AbstractSelect<span class="signature">()</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="ui_base_abstract-select.js.html">ui/base/abstract-select.js</a>, <a href="ui_base_abstract-select.js.html#line10">line 10</a>
    </li></ul></dd>
