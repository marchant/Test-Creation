...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: DateValidator</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: DateValidator</h1>
...
<header>
        ...
        DateValidator
            ...
            <div class="class-description">Validate that date provided as string/number can be converted to a Date Object using the pattern provided.</div>
...
<article>
    ...
    <h4 class="name" id="DateValidator"><span class="type-signature"></span>new DateValidator<span class="signature">()</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="core_converter_date-converter.js.html">core/converter/date-converter.js</a>, <a href="core_converter_date-converter.js.html#line2485">line 2485</a>
    </li></ul></dd>
