...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: ui/segmented-bar.info/sample/ui/main.reel/main.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: ui/segmented-bar.info/sample/ui/main.reel/main.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>var Component = require("montage/ui/component").Component;
