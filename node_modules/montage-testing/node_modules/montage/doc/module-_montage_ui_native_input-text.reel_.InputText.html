...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: InputText</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: InputText</h1>
...
<header>
        ...
        <h2>
            <span class="ancestors"><a href="module-_montage_ui_native_input-text.reel_.html">"montage/ui/native/input-text.reel"</a>.</span>
...
<article>
    ...
    <h4 class="name" id="InputText"><span class="type-signature"></span>new InputText<span class="signature">()</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="ui_text-field.reel_text-field.js.html">ui/text-field.reel/text-field.js</a>, <a href="ui_text-field.reel_text-field.js.html#line6">line 6</a>
    </li></ul></dd>
