...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: data/model/data-property-descriptor.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: data/model/data-property-descriptor.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>var PropertyDescriptor = require("data/model/property-descriptor").PropertyDescriptor;
