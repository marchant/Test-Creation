...
<div id="main">
    ...
    <h1 class="page-title">External: Array</h1>
...
<header>
        ...
        <h2>
            <span class="ancestors"><a href="module-montage_core_shim_array.html">montage/core/shim/array</a>~</span>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="core_shim_array.js.html">core/shim/array.js</a>, <a href="core_shim_array.js.html#line7">line 7</a>
    </li></ul></dd>
    ...
    <h4 class="name" id=".isArray"><span class="type-signature">(static) </span>isArray<span class="signature">(value)</span><span class="type-signature"> &rarr; {boolean}</span></h4>
...
<span class="param-type">Any</span>
            ...
            <td class="description last">any value</td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="core_shim_array.js.html">core/shim/array.js</a>, <a href="core_shim_array.js.html#line11">line 11</a>
    </li></ul></dd>
