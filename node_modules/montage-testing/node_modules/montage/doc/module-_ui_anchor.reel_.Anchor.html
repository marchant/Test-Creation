...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: Anchor</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: Anchor</h1>
...
<article>
    ...
    <h4 class="name" id="Anchor"><span class="type-signature"></span>new Anchor<span class="signature">()</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="ui_anchor.reel_anchor.js.html">ui/anchor.reel/anchor.js</a>, <a href="ui_anchor.reel_anchor.js.html#line5">line 5</a>
    </li></ul></dd>
    ...
    <ul>
        <li>module:ui/control.Control</li>
    </ul>
