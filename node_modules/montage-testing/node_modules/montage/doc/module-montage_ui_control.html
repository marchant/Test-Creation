...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Module: montage/ui/control</title>
...
<div id="main">
    ...
    <h1 class="page-title">Module: montage/ui/control</h1>
...
<article>
    <div class="container-overview">
        ...
        <dl>
            <dt><a href="module-montage_ui_control.Control.html">Control</a></dt>
            <dd></dd>
        </dl>
    ...
    <h4 class="name" id="~event:longpress">longpress</h4>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="ui_control.js.html">ui/control.js</a>, <a href="ui_control.js.html#line252">line 252</a>
    </li></ul></dd>
