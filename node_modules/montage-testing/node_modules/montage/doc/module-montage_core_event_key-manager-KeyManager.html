...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: KeyManager</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: KeyManager</h1>
...
<header>
        ...
        <h2>
            <span class="ancestors"><a href="module-montage_core_event_key-manager.html">montage/core/event/key-manager</a>~</span>
        
        KeyManager
        </h2>
        
            <div class="class-description">Dispatches events to a key composer. There can only be one.</div>
...
<article>
    ...
    <h4 class="name" id="KeyManager"><span class="type-signature"></span>new KeyManager<span class="signature">()</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="core_event_key-manager.js.html">core/event/key-manager.js</a>, <a href="core_event_key-manager.js.html#line195">line 195</a>
    </li></ul></dd>
...
<footer>
    Documentation generated by <a href="https://github.com/jsdoc3/jsdoc">JSDoc 3.3.2</a> on Wed Nov 15 2017 12:53:36 GMT-0800 (PST)
</footer>
