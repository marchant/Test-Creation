...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: Condition</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: Condition</h1>
...
<header>
        ...
        <h2>
            <span class="ancestors"><a href="module-_montage_ui_condition.reel_.html">"montage/ui/condition.reel"</a>~</span>
        
        Condition
        </h2>
        
            <div class="class-description">A component that shows or hides its inner template in response to
changes to some condition.</div>
...
<article>
    ...
    <h4 class="name" id="Condition"><span class="type-signature"></span>new Condition<span class="signature">()</span><span class="type-signature"></span></h4>
...
condition property is `true`, and hides its DOM
...
removalStrategy can be changed to alter
this behavior.
</div>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="ui_condition.reel_condition.js.html">ui/condition.reel/condition.js</a>, <a href="ui_condition.reel_condition.js.html#line7">line 7</a>
    </li></ul></dd>
...
<footer>
    Documentation generated by <a href="https://github.com/jsdoc3/jsdoc">JSDoc 3.3.2</a> on Wed Nov 15 2017 12:53:32 GMT-0800 (PST)
</footer>
