...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: ui/image-gallery-item.reel/image-gallery-item.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: ui/image-gallery-item.reel/image-gallery-item.js</h1>
