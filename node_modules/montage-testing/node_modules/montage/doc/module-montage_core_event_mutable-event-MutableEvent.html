...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: MutableEvent</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: MutableEvent</h1>
...
<header>
        ...
        <h2>
            <span class="ancestors"><a href="module-montage_core_event_mutable-event.html">montage/core/event/mutable-event</a>~</span>
...
<article>
    ...
    <h4 class="name" id="MutableEvent"><span class="type-signature"></span>new MutableEvent<span class="signature">()</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="core_event_mutable-event.js.html">core/event/mutable-event.js</a>, <a href="core_event_mutable-event.js.html#line33">line 33</a>
    </li></ul></dd>
