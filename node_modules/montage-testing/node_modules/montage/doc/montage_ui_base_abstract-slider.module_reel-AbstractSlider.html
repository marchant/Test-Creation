...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: AbstractSlider</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: AbstractSlider</h1>
...
<header>
        ...
        <h2>
            <span class="ancestors"><a href="montage_ui_base_abstract-slider.module_reel.html">.reel</a>~</span>
...
<article>
    ...
    <h4 class="name" id="AbstractSlider"><span class="type-signature"></span>new AbstractSlider<span class="signature">()</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="ui_base_abstract-slider.js.html">ui/base/abstract-slider.js</a>, <a href="ui_base_abstract-slider.js.html#line14">line 14</a>
    </li></ul></dd>
