...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Module: montage/core/event/event-manager</title>
...
<div id="main">
    ...
    <h1 class="page-title">Module: montage/core/event/event-manager</h1>
...
<article>
    <div class="container-overview">
        ...
        <ul>
            ...
            <li><a href="module-montage_core_event_mutable-event.html">module:montage/core/event/mutable-event</a></li>
        
            <li><a href="module-montage_core_serialization.html">module:montage/core/serialization</a></li>
        
            <li><a href="module-montage_core_event_action-event-listener.html">module:montage/core/event/action-event-listener</a></li>
        </ul>
        ...
        <dl>
            <dt><a href="module-montage_core_event_event-manager-EventManager.html">EventManager</a></dt>
            <dd></dd>
        </dl>
