...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: PressComposer</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: PressComposer</h1>
...
<header>
        ...
        <h2>
            <span class="ancestors"><a href="module-montage_composer_press-composer.html">montage/composer/press-composer</a>~</span>
        
        PressComposer
        </h2>
        
            <div class="class-description">The `PressComposer` abstracts away handling mouse and touch
events that represent presses, allowing generic detection of presses, long
presses, and cancelled presses.</div>
...
<article>
    ...
    <h4 class="name" id="PressComposer"><span class="type-signature"></span>new PressComposer<span class="signature">()</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="composer_press-composer.js.html">composer/press-composer.js</a>, <a href="composer_press-composer.js.html#line87">line 87</a>
    </li></ul></dd>
...
<h5>Fires:</h5>
<ul>
    <li>event:pressStart</li>

    <li>event:press</li>

    <li>event:longPress</li>

    <li>event:pressCancel</li>
</ul>
