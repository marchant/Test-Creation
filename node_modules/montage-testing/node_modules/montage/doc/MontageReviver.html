...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: MontageReviver</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: MontageReviver</h1>
...
<article>
    ...
    <h4 class="name" id="MontageReviver"><span class="type-signature"></span>new MontageReviver<span class="signature">()</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="core_serialization_deserializer_montage-reviver.js.html">core/serialization/deserializer/montage-reviver.js</a>, <a href="core_serialization_deserializer_montage-reviver.js.html#line90">line 90</a>
    </li></ul></dd>
...
<h4 class="name" id=".parseObjectLocationId"><span class="type-signature">(static) </span>parseObjectLocationId<span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="core_serialization_deserializer_montage-reviver.js.html">core/serialization/deserializer/montage-reviver.js</a>, <a href="core_serialization_deserializer_montage-reviver.js.html#line937">line 937</a>
    </li></ul></dd>
    ...
    <pre class="prettyprint"><code>"event/event-manager" has a default objectName of EventManager.

When the last path component ends with ".reel" it is removed before
creating the default objectName.</code></pre>

    <pre class="prettyprint"><code>"matte/ui/input-range.reel" has a default objectName of
         InputRange.</code></pre>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="core_serialization_deserializer_montage-reviver.js.html">core/serialization/deserializer/montage-reviver.js</a>, <a href="core_serialization_deserializer_montage-reviver.js.html#line108">line 108</a>
    </li></ul></dd>
