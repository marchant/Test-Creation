...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Module: "montage/ui/segmented-bar.reel"</title>
...
<div id="main">
    ...
    <h1 class="page-title">Module: "montage/ui/segmented-bar.reel"</h1>
...
<article>
    <div class="container-overview">
        ...
        <ul>
            <li><a href="module-montage_ui_base_abstract-button.html">module:montage/ui/base/abstract-button</a></li>
        
            <li><a href="module-montage_core_range-controller.html">module:montage/core/range-controller</a></li>
        
            <li>module:montage/core/tree-controller</li>
        </ul>
        ...
        <dl>
            <dt><a href="module-_montage_ui_segmented-bar.reel_-SegmentedBar.html">SegmentedBar</a></dt>
            <dd></dd>
        </dl>
