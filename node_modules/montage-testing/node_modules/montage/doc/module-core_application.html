...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Module: core/application</title>
...
<div id="main">
    ...
    <h1 class="page-title">Module: core/application</h1>
...
<article>
    <div class="container-overview">
        ...
        <ul>
            <li>module:event/event-manager</li>
        
            <li>module:template</li>
        
            <li>module:ui/popup/popup</li>
        
            <li>module:ui/popup/alert</li>
        
            <li>module:ui/popup/confirm</li>
        
            <li>module:ui/loading</li>
        
            <li>module:ui/popup/growl</li>
        
            <li>module:ui/slot</li>
        </ul>
        ...
        <dl>
            <dt><a href="module-core_application-Application.html">Application</a></dt>
            <dd></dd>
        </dl>
