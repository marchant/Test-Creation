...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: data/service/data-stream.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: data/service/data-stream.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>// Note: Montage's promises are used even if ECMAScript 6 promises are available.
