...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: core/shim/array.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: core/shim/array.js</h1>
    ...
    value: function (objects, clearRemovedObjects) {
        ...
        if(typeof objects.has === "function") {
            while(++j&lt;length) {
                ...
                else if(clearRemovedObjects) {
                    objects.delete(this[j]);
                }
            }
