...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Module: montage/core/shim/array</title>
...
<div id="main">
    ...
    <h1 class="page-title">Module: montage/core/shim/array</h1>
...
<article>
    <div class="container-overview">
            ...
            <div class="description">Defines standardized shims to intrinsic `Array` object.</div>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="core_shim_array.js.html">core/shim/array.js</a>, <a href="core_shim_array.js.html#line1">line 1</a>
    </li></ul></dd>
    ...
    <dd class="tag-see">
        <ul>
            <li>{<a href="external-Array.html">external:Array</a>}</li>
        </ul>
    </dd>
