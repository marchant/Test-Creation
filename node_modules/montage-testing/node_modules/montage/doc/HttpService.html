...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: HttpService</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: HttpService</h1>
...
<article>
    ...
    <h4 class="name" id="HttpService"><span class="type-signature"></span>new HttpService<span class="signature">()</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="data_service_http-service.js.html">data/service/http-service.js</a>, <a href="data_service_http-service.js.html#line84">line 84</a>
    </li></ul></dd>
        ...
        <dl>
            <dt><a href="HttpService.DataType.html">DataType</a></dt>
            <dd></dd>
        </dl>
...
<h4 class="name" id="authorizationHeaderName"><span class="type-signature"></span>authorizationHeaderName<span class="type-signature"> :string</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="data_service_http-service.js.html">data/service/http-service.js</a>, <a href="data_service_http-service.js.html#line142">line 142</a>
    </li></ul></dd>
...
<h4 class="name" id="authorizationHeaderValue"><span class="type-signature"></span>authorizationHeaderValue<span class="type-signature"> :string</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="data_service_http-service.js.html">data/service/http-service.js</a>, <a href="data_service_http-service.js.html#line151">line 151</a>
    </li></ul></dd>
...
<h4 class="name" id="authorizationHeaderValueExpression"><span class="type-signature"></span>authorizationHeaderValueExpression<span class="type-signature"> :string</span></h4>




<div class="description">
    FRB Expression defining the authorizationHeaderValue when evaluated against a DataQuery
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="data_service_http-service.js.html">data/service/http-service.js</a>, <a href="data_service_http-service.js.html#line161">line 161</a>
    </li></ul></dd>
...
<h4 class="name" id="FORM_URL_ENCODED"><span class="type-signature"></span>FORM_URL_ENCODED<span class="type-signature"> :Object.&lt;string, string></span></h4>
...
<a href="https://www.w3.org/TR/html401/interact/forms.html#h-17.13.4.1">application/x-www-form-urlencoded</a>,
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="data_service_http-service.js.html">data/service/http-service.js</a>, <a href="data_service_http-service.js.html#line97">line 97</a>
    </li></ul></dd>
...
<h4 class="name" id="FORM_URL_ENCODED_CONTENT_TYPE_HEADER"><span class="type-signature"></span>FORM_URL_ENCODED_CONTENT_TYPE_HEADER<span class="type-signature"> :Object.&lt;string, string></span></h4>
...
<dl class="details">
        ...
        <dt class="important tag-deprecated">Deprecated:</dt><dd><ul class="dummy"><li>in favor of
            <a href="HttpService.html#FORM_URL_ENCODED">FORM_URL_ENCODED</a>.</li></ul></dd>
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="data_service_http-service.js.html">data/service/http-service.js</a>, <a href="data_service_http-service.js.html#line106">line 106</a>
    </li></ul></dd>
    ...
    <h4 class="name" id="_authRegexp"><span class="type-signature"></span>_authRegexp<span class="signature">(url, headers<span class="signature-attributes">opt</span>, body<span class="signature-attributes">opt</span>, types<span class="signature-attributes">opt</span>, sendCredentials<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {external:Promise}</span></h4>
...
<span class="param-type">String</span>
            ...
            <td class="description last">The URL of the endpoint.</td>
        </tr>
...
<span class="param-type">Object.&lt;string, string></span>
        ...
        <tr>
            ...
            <td class="description last">The body to send with the
...
<span class="param-type">Array.&lt;<a href="HttpService.DataType.html">HttpService.DataType</a>></span>
                ...
                <td class="default">
                    ...
                    [HttpService.DataType.JSON]
                
                </td>
            

            <td class="description last">The possible types of
                                                ...
                                                of
                                                <a href="HttpService.DataType.html">DataType</a>
                                                arguments.</td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>sendCredentials</code></td>
...
<span class="param-type">boolean</span>
            ...
            <td class="description last">Determines whether
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="data_service_http-service.js.html">data/service/http-service.js</a>, <a href="data_service_http-service.js.html#line285">line 285</a>
    </li></ul></dd>
...
<div class="param-desc">
    - A promise settled when the fetch is
