...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: UpperCaseConverter</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: UpperCaseConverter</h1>
...
<header>
        ...
        <h2>
            <span class="ancestors"><a href="module-montage_core_converter_upper-case-converter.html">montage/core/converter/upper-case-converter</a>~</span>
        
        UpperCaseConverter
        </h2>
        
            <div class="class-description">Converts a string to upper-case.</div>
...
<article>
    ...
    <h4 class="name" id="UpperCaseConverter"><span class="type-signature"></span>new UpperCaseConverter<span class="signature">()</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="core_converter_upper-case-converter.js.html">core/converter/upper-case-converter.js</a>, <a href="core_converter_upper-case-converter.js.html#line10">line 10</a>
    </li></ul></dd>
