...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: Checkbox</title>
...
<header>
        ...
        <h2>
            <span class="ancestors"><a href="module-_montage_ui_native_checkbox.reel_.html">"montage/ui/native/checkbox.reel"</a>.</span>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="ui_checkbox.reel_checkbox.js.html">ui/checkbox.reel/checkbox.js</a>, <a href="ui_checkbox.reel_checkbox.js.html#line8">line 8</a>
    </li></ul></dd>
    ...
    <ul>
        <li>module:montage/ui/check-control.CheckControl</li>
    </ul>
