...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: data/service/data-selector.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: data/service/data-selector.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>var DataSelector = require("data/model/data-selector").DataSelector;
