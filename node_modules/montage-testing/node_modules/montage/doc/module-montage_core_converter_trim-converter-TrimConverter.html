...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: TrimConverter</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: TrimConverter</h1>
...
<header>
        ...
        TrimConverter
            ...
            <div class="class-description">Trims a string of white space.</div>
...
<article>
    ...
    <h4 class="name" id="TrimConverter"><span class="type-signature"></span>new TrimConverter<span class="signature">()</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="core_converter_trim-converter.js.html">core/converter/trim-converter.js</a>, <a href="core_converter_trim-converter.js.html#line11">line 11</a>
    </li></ul></dd>
    ...
    <h5>Example</h5>
        ...
        <p class="code-caption">Removes leading and trailing white space from a string.</p>
    
    <pre class="prettyprint"><code>var Converter= require("./converter").Converter,
...
// After trim: Hello World</code></pre>
