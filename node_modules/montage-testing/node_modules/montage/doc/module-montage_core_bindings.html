...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Module: montage/core/bindings</title>
...
<div id="main">
    ...
    <h1 class="page-title">Module: montage/core/bindings</h1>
...
<h4 class="name" id=".Bindings"><span class="type-signature">(static) </span>Bindings<span class="type-signature"></span></h4>
...
<dl class="details">
        ...
        <dt class="important tag-deprecated">Deprecated:</dt><dd><ul class="dummy"><li>console.log montage/core/bindings is deprecated, use montage/core/core instead</li></ul></dd>
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="core_bindings.js.html">core/bindings.js</a>, <a href="core_bindings.js.html#line11">line 11</a>
    </li></ul></dd>
