...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Module: "montage/ui/native/input-date.reel"</title>
...
<div id="main">
    ...
    <h1 class="page-title">Module: "montage/ui/native/input-date.reel"</h1>
...
<article>
    <div class="container-overview">
        ...
        <ul>
            ...
            <li><a href="module-montage_ui_text-input.html">module:montage/ui/text-input</a></li>
        </ul>
        ...
        <dl>
            <dt><a href="module-_montage_ui_native_input-date.reel_.InputDate.html">InputDate</a></dt>
            <dd></dd>
        </dl>
