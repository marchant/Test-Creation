...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: DataStream</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: DataStream</h1>
...
<article>
    ...
    <h4 class="name" id="DataStream"><span class="type-signature"></span>new DataStream<span class="signature">()</span><span class="type-signature"></span></h4>
...
<div class="description">
    A <a href="DataProvider.html">DataProvider</a> whose data is received sequentially.
A DataStream is also a <code>promise</code> which is
fulfilled when all the data it expects has been received.

Objects receiving data from a stream will use its
<a href="DataStream.html#data">data</a> property to access that data. Alternatively
they can use its <a href="DataStream.html#then">then()</a> method to get that data or
to handle errors, or its <a href="DataStream.html#catch">catch()</a> method to handle
errors.

Objects feeding data to a stream will use its
<a href="DataStream.html#addData">addData()</a> method to add that data and its
<a href="DataStream.html#dataDone">dataDone()</a> method to indicate that all available
data has been added or its <a href="DataStream.html#dataError">dataError()</a> method
...
stream. Typically that object will be a <a href="DataService.html">Service</a>.

Each stream is also a <code>promise</code> that becomes
fulfilled when all the data expected for it is first received and
<a href="DataStream.html#dataDone">dataDone()</a> is called, or rejected when an
error is first encountered and <a href="DataStream.html#dataError">dataError()</a>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="data_service_data-stream.js.html">data/service/data-stream.js</a>, <a href="data_service_data-stream.js.html#line44">line 44</a>
    </li></ul></dd>
    ...
    <ul>
        <li><a href="DataProvider.html">DataProvider</a></li>
    </ul>
...
<h4 class="name" id=".withTypeOrSelector"><span class="type-signature">(static) </span>withTypeOrSelector<span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="data_service_data-stream.js.html">data/service/data-stream.js</a>, <a href="data_service_data-stream.js.html#line352">line 352</a>
    </li></ul></dd>
...
<h4 class="name" id="_dataMaxAge"><span class="type-signature"></span>_dataMaxAge<span class="type-signature"> :Number</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="data_service_data-stream.js.html">data/service/data-stream.js</a>, <a href="data_service_data-stream.js.html#line330">line 330</a>
    </li></ul></dd>
...
<a href="DataProvider.html">DataProvider</a> superclass. This array is created
...
<dl class="details">
    ...
    <dd class="tag-overrides"><ul class="dummy"><li>
        <a href="DataProvider.html#data">DataProvider#data</a>
    </li></ul></dd>
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="data_service_data-stream.js.html">data/service/data-stream.js</a>, <a href="data_service_data-stream.js.html#line84">line 84</a>
    </li></ul></dd>
...
<h4 class="name" id="dataReceptionTime"><span class="type-signature"></span>dataReceptionTime<span class="type-signature"> :Date</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="data_service_data-stream.js.html">data/service/data-stream.js</a>, <a href="data_service_data-stream.js.html#line319">line 319</a>
    </li></ul></dd>
...
<h4 class="name" id="query"><span class="type-signature"></span>query<span class="type-signature"> :<a href="DataQuery.html">DataQuery</a></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="data_service_data-stream.js.html">data/service/data-stream.js</a>, <a href="data_service_data-stream.js.html#line55">line 55</a>
    </li></ul></dd>
...
<h4 class="name" id="selector"><span class="type-signature"></span>selector<span class="type-signature"> :<a href="DataQuery.html">DataQuery</a></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="data_service_data-stream.js.html">data/service/data-stream.js</a>, <a href="data_service_data-stream.js.html#line64">line 64</a>
    </li></ul></dd>
    ...
    <h4 class="name" id="addData"><span class="type-signature"></span>addData<span class="signature">(objects)</span><span class="type-signature"></span></h4>
...
<div class="description">
    Add some object to the stream's <a href="DataStream.html#data">data</a> array.
</div>
...
<span class="param-type">Array</span>
            ...
            <td class="description last">An array of objects to add to the stream's
                            data. If this array is empty, `null`, or
                            `undefined`, no objects are added.</td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="data_service_data-stream.js.html">data/service/data-stream.js</a>, <a href="data_service_data-stream.js.html#line236">line 236</a>
    </li></ul></dd>
    ...
    <h4 class="name" id="catch"><span class="type-signature"></span>catch<span class="signature">(onRejected)</span><span class="type-signature"></span></h4>
...
<div class="description">
    Method of the <code>Promise</code> class used to
...
<span class="param-type">OnRejected</span>
            ...
            <td class="description last">Called when the stream's
                                      <a href="DataStream.html#dataError">dataError()</a>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="data_service_data-stream.js.html">data/service/data-stream.js</a>, <a href="data_service_data-stream.js.html#line218">line 218</a>
    </li></ul></dd>
    ...
    <h4 class="name" id="dataDone"><span class="type-signature"></span>dataDone<span class="signature">()</span><span class="type-signature"></span></h4>
...
to its <a href="DataStream.html#data">data</a> array. After this is called
all subsequent calls to <a href="DataStream.html#dataDone">dataDone()</a>
or <a href="DataStream.html#dataError">dataError()</a> will be ignored.
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="data_service_data-stream.js.html">data/service/data-stream.js</a>, <a href="data_service_data-stream.js.html#line260">line 260</a>
    </li></ul></dd>
    ...
    <h4 class="name" id="dataError"><span class="type-signature"></span>dataError<span class="signature">(reason<span class="signature-attributes">opt</span>)</span><span class="type-signature"></span></h4>
...
calls to <a href="DataStream.html#dataError">dataError()</a> or
<a href="DataStream.html#dataDone">dataDone()</a> will be ignored.
</div>
...
<span class="param-type">Object</span>
            ...
            <td class="description last">An object, usually an Error,
                              indicating what caused the problem.
                              This will be passed in to any
                              external:onRejected
                              callback specified in
                              <a href="DataStream.html#then">then()</a> or
                              <a href="DataStream.html#catch">catch()</a> calls
                              to the stream.</td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="data_service_data-stream.js.html">data/service/data-stream.js</a>, <a href="data_service_data-stream.js.html#line284">line 284</a>
    </li></ul></dd>
    ...
    <h4 class="name" id="requestData"><span class="type-signature"></span>requestData<span class="signature">(start, length)</span><span class="type-signature"></span></h4>
...
<a href="DataProvider.html">DataProvider</a> superclass. Calling this method has
...
<span class="param-type">int</span>
            ...
            <td class="description last">See <a href="DataProvider.html#requestData">superclass</a>.</td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-overrides">Overrides:</dt>
    <dd class="tag-overrides"><ul class="dummy"><li>
        <a href="DataProvider.html#requestData">DataProvider#requestData</a>
    </li></ul></dd>
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="data_service_data-stream.js.html">data/service/data-stream.js</a>, <a href="data_service_data-stream.js.html#line103">line 103</a>
    </li></ul></dd>
    ...
    <h4 class="name" id="then"><span class="type-signature"></span>then<span class="signature">(onFulfilled, onRejected<span class="signature-attributes">opt</span>)</span><span class="type-signature"></span></h4>
...
<span class="param-type">OnFulfilled</span>
            ...
            <td class="description last">Called when the stream's
                                      <a href="DataStream.html#dataDone">dataDone()</a>
                                      ...
                                      <a href="DataStream.html#data">data</a> array
                                      ...
                                      stream's <a href="DataStream.html#data">DataStream#data</a>.</td>
        </tr>
...
<span class="param-type">OnRejected</span>
            ...
            <td class="description last">Called when the stream's
                                      ...
                                      <a href="DataStream.html#dataError">dataError()</a>
                                      method. Because
                                      <a href="DataStream.html#catch">catch()</a>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="data_service_data-stream.js.html">data/service/data-stream.js</a>, <a href="data_service_data-stream.js.html#line196">line 196</a>
    </li></ul></dd>
