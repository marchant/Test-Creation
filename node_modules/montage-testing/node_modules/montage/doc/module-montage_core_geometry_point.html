...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Module: montage/core/geometry/point</title>
...
<div id="main">
    ...
    <h1 class="page-title">Module: montage/core/geometry/point</h1>
...
<article>
    <div class="container-overview">
        ...
        <dl>
            <dt><a href="module-montage_core_geometry_point-Point.html">Point</a></dt>
            <dd></dd>
        </dl>
    ...
    <h4 class="name" id="~interpolate"><span class="type-signature">(inner) </span>interpolate<span class="signature">(percent, point0, point1, precision)</span><span class="type-signature"></span></h4>
...
<span class="param-type">Axis</span>
            ...
            <td class="description last">The interpolation percentage.</td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>point0</code></td>
...
<span class="param-type">Axis</span>
            ...
            <td class="description last">The 0 interpolation point.</td>
        </tr>
...
<span class="param-type">Axis</span>
            ...
            <td class="description last">The 1 interpolation point.</td>
        </tr>
...
<span class="param-type">Axis</span>
            ...
            <td class="description last">The interpolation precision.</td>
        </tr>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="core_geometry_point.js.html">core/geometry/point.js</a>, <a href="core_geometry_point.js.html#line53">line 53</a>
    </li></ul></dd>
