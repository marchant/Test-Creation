...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Module: montage/core/meta/validation-rule</title>
...
<div id="main">
    ...
    <h1 class="page-title">Module: montage/core/meta/validation-rule</h1>
...
<article>
    <div class="container-overview">
        ...
        <ul>
            ...
            <li>module:core/exception</li>
        
            <li>module:core/promise</li>
        
            <li>module:core/logger</li>
        </ul>
        ...
        <dl>
            <dt><a href="module-montage_core_meta_validation-rule-PropertyValidationRule.html">PropertyValidationRule</a></dt>
            <dd></dd>
        </dl>
