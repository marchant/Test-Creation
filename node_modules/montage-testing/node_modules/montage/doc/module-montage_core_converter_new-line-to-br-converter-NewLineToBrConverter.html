...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: NewLineToBrConverter</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: NewLineToBrConverter</h1>
...
<header>
        ...
        <h2>
            <span class="ancestors"><a href="module-montage_core_converter_new-line-to-br-converter.html">montage/core/converter/new-line-to-br-converter</a>~</span>
        
        NewLineToBrConverter
        </h2>
        
            <div class="class-description">Converts a newline to a &lt;br&gt; tag.</div>
...
<article>
    ...
    <h4 class="name" id="NewLineToBrConverter"><span class="type-signature"></span>new NewLineToBrConverter<span class="signature">()</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="core_converter_new-line-to-br-converter.js.html">core/converter/new-line-to-br-converter.js</a>, <a href="core_converter_new-line-to-br-converter.js.html#line21">line 21</a>
    </li></ul></dd>
