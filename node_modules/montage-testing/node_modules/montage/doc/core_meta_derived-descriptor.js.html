...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: core/meta/derived-descriptor.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: core/meta/derived-descriptor.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>var PropertyDescriptor = require("./property-descriptor").PropertyDescriptor,
