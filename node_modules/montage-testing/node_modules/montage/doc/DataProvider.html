...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: DataProvider</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: DataProvider</h1>
...
<article>
    ...
    <h4 class="name" id="DataProvider"><span class="type-signature"></span>new DataProvider<span class="signature">()</span><span class="type-signature"></span></h4>
...
DataProvider protocol. Data provider classes
can extend this class but they aren't required to, they just need to have the
<a href="DataProvider.html#data">data</a> property and the
<a href="DataProvider.html#requestData">requestData()</a> method of this class.
</div>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="data_service_data-provider.js.html">data/service/data-provider.js</a>, <a href="data_service_data-provider.js.html#line15">line 15</a>
    </li></ul></dd>
...
<div class="description">
    At any point in time a data provider’s <a href="DataProvider.html#data">data</a>
...
will need to be in its <a href="DataProvider.html#data">data</a> array but doesn’t
...
data provider’s <a href="DataProvider.html#data">data</a> array is an unambiguous
...
reason, it will update its <a href="DataProvider.html#data">data</a> array
...
<code>Repetition</code> will automatically do this
monitoring.

Although the contents of a data provider's
<a href="DataProvider.html#data">data</a> array may change over time, the array
itself will not change. Subclasses will typically want to create the
<a href="DataProvider.html#data">data</a> array lazilly the first time it is needed
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="data_service_data-provider.js.html">data/service/data-provider.js</a>, <a href="data_service_data-provider.js.html#line55">line 55</a>
    </li></ul></dd>
...
<a href="DataProvider.html#requestData">requestData()</a> method to indicate that
they want the data in the specified range. If the requested data is not
in the provider’s <a href="DataProvider.html#data">data</a> array yet, and if that
...
<a href="DataProvider.html#data">data</a> property above.
...
<a href="DataProvider.html#data">data</a> array. Also, no guarantee is given that a
data provider will provide through its <a href="DataProvider.html#data">data</a>
array only the data specifically requested in
<a href="DataProvider.html#requestData">requestData()</a> calls: It may obtain and
provide more data.

In spite of these lack of guarantees data providers try to be smart about
what data they provide or withhold based on
<a href="DataProvider.html#requestData">requestData()</a> calls and based on
...
<span class="param-type">int</span>
            ...
            <td class="description last">The index of the start of the range of the
                         requested data. When `undefined`, all available
                         data is requested.</td>
        </tr>
...
<span class="param-type">int</span>
            ...
            <td class="description last">The length of the range of the requested data.
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="data_service_data-provider.js.html">data/service/data-provider.js</a>, <a href="data_service_data-provider.js.html#line91">line 91</a>
    </li></ul></dd>
