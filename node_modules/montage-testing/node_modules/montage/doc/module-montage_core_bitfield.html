...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Module: montage/core/bitfield</title>
...
<div id="main">
    ...
    <h1 class="page-title">Module: montage/core/bitfield</h1>
...
<article>
    <div class="container-overview">
            ...
            <div class="description">Defines the BitField class, that compactly stores multiple values as a short
series of bits.</div>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="core_bitfield.js.html">core/bitfield.js</a>, <a href="core_bitfield.js.html#line1">line 1</a>
    </li></ul></dd>
        ...
        <dl>
            <dt><a href="module-montage_core_bitfield-BitField.html">BitField</a></dt>
            <dd></dd>
        </dl>
