...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Module: montage/core/extras/function</title>
...
<div id="main">
    ...
    <h1 class="page-title">Module: montage/core/extras/function</h1>
...
<article>
    <div class="container-overview">
            ...
            <div class="description">Defines extensions to intrinsic `Function` object.</div>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="core_extras_function.js.html">core/extras/function.js</a>, <a href="core_extras_function.js.html#line1">line 1</a>
    </li></ul></dd>
    ...
    <dd class="tag-see">
        <ul>
            <li>{<a href="external-Function.html">external:Function</a>}</li>
        </ul>
    </dd>
