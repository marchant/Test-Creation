...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: SegmentedBar</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: SegmentedBar</h1>
...
<header>
        ...
        <h2>
            <span class="ancestors"><a href="module-_montage_ui_segmented-bar.reel_.html">"montage/ui/segmented-bar.reel"</a>~</span>
        
        SegmentedBar
        </h2>
        
            <div class="class-description">SegmentedBar

A bar consisted of <a href="Segment.html">Segment</a> components. Commonly used to visualize data, such as disk space usage.
Will accept an array of objects, `RangeController` or `TreeController` as data source.
`SegmentedBar` subclasses `AbstractButton` because of `AbstractButton`'s desired `PressComposer` behavior.</div>
...
<article>
    ...
    <h4 class="name" id="SegmentedBar"><span class="type-signature"></span>new SegmentedBar<span class="signature">()</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="ui_segmented-bar.reel_segmented-bar.js.html">ui/segmented-bar.reel/segmented-bar.js</a>, <a href="ui_segmented-bar.reel_segmented-bar.js.html#line26">line 26</a>
    </li></ul></dd>
    ...
    <dd class="tag-see">
        <ul>
            <li><a href="https://developer.mozilla.org/en-US/docs/Web/Guide/CSS/Flexible_boxes">https://developer.mozilla.org/en-US/docs/Web/Guide/CSS/Flexible_boxes</a>
for FlexBox usage</li>
        </ul>
    </dd>
    ...
    <ul>
        <li><a href="AbstractButton.html">AbstractButton</a></li>
    </ul>
...
<span class="param-type">Map</span>
            ...
            <td class="description last">The detail object as defined in AbstractControl#detail</td>
        </tr>
...
<dl class="details">
    ...
    <dd class="inherited-from"><ul class="dummy"><li>
        <a href="AbstractButton.html#event:action">AbstractButton#event:action</a>
    </li></ul></dd>
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="ui_base_abstract-button.js.html">ui/base/abstract-button.js</a>, <a href="ui_base_abstract-button.js.html#line17">line 17</a>
    </li></ul></dd>
    ...
    <h4 class="name" id="event:longAction">longAction</h4>
...
<table class="props">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="description last">detail - The detail object as defined in AbstractControl#detail</td>
        </tr>
...
<dl class="details">
    ...
    <dt class="inherited-from">Inherited From:</dt>
    <dd class="inherited-from"><ul class="dummy"><li>
        <a href="AbstractButton.html#event:longAction">AbstractButton#event:longAction</a>
    </li></ul></dd>
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="ui_base_abstract-button.js.html">ui/base/abstract-button.js</a>, <a href="ui_base_abstract-button.js.html#line25">line 25</a>
    </li></ul></dd>
