...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Module: "montage/ui/native/select.reel"</title>
...
<div id="main">
    ...
    <h1 class="page-title">Module: "montage/ui/native/select.reel"</h1>
...
<article>
    <div class="container-overview">
        ...
        <dl>
            <dt><a href="module-_montage_ui_native_select.reel_.Select.html">Select</a></dt>
            <dd>If the &lt;select&gt; markup contains <option> is provided in the markup
    ...
    <code>contentController</code> when they are available.</dd>
        </dl>
