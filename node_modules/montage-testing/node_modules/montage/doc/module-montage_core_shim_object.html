...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Module: montage/core/shim/object</title>
...
<div id="main">
    ...
    <h1 class="page-title">Module: montage/core/shim/object</h1>
...
<article>
    <div class="container-overview">
            ...
            <div class="description">Defines standardized shims for the intrinsic `Object`.</div>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="core_shim_object.js.html">core/shim/object.js</a>, <a href="core_shim_object.js.html#line1">line 1</a>
    </li></ul></dd>
    ...
    <dd class="tag-see">
        <ul>
            <li>{<a href="external-Object.html">external:Object</a>}</li>
        </ul>
    </dd>
