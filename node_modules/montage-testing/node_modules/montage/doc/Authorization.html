...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: Authorization</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: Authorization</h1>
...
<article>
    ...
    <h4 class="name" id="Authorization"><span class="type-signature"></span>new Authorization<span class="signature">()</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="data_service_authorization.js.html">data/service/authorization.js</a>, <a href="data_service_authorization.js.html#line11">line 11</a>
    </li></ul></dd>
