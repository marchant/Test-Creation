...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: InputRadio</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: InputRadio</h1>
...
<article>
    ...
    <h4 class="name" id="InputRadio"><span class="type-signature"></span>new InputRadio<span class="signature">()</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="ui_radio.reel_radio.js.html">ui/radio.reel/radio.js</a>, <a href="ui_radio.reel_radio.js.html#line7">line 7</a>
    </li></ul></dd>
    ...
    <ul>
        <li>module:montage/ui/check-input.CheckInput</li>
    </ul>
