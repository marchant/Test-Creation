...
<header>
        ...
        <h2>
            <span class="ancestors"><a href="module-montage_ui_text-input.html">montage/ui/text-input</a>.</span>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="ui_text-input.js.html">ui/text-input.js</a>, <a href="ui_text-input.js.html#line7">line 7</a>
    </li></ul></dd>
    ...
    <dd class="tag-see">
        <ul>
            <li>{module:"montage/ui/input-date.reel".DateInput}</li>
        
            <li>module:"montage/ui/input-text.reel".InputText</li>
        
            <li>module:"montage/ui/input-number.reel".InputNumber</li>
        
            <li>module:"montage/ui/input-range.reel".RangeInput</li>
        
            <li>module:"montage/ui/textarea.reel".TextArea</li>
        </ul>
    </dd>
