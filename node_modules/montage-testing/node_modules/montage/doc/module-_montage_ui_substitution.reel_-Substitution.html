...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: Substitution</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: Substitution</h1>
...
<header>
        ...
        <h2>
            <span class="ancestors"><a href="module-_montage_ui_substitution.reel_.html">"montage/ui/substitution.reel"</a>~</span>
        
        Substitution
        </h2>
        
            <div class="class-description">A structural component that reveals one of its template arguments
at a time.</div>
...
<article>
    ...
    <h4 class="name" id="Substitution"><span class="type-signature"></span>new Substitution<span class="signature">()</span><span class="type-signature"></span></h4>
...
switchValue property. The available values
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="ui_substitution.reel_substitution.js.html">ui/substitution.reel/substitution.js</a>, <a href="ui_substitution.reel_substitution.js.html#line8">line 8</a>
    </li></ul></dd>
