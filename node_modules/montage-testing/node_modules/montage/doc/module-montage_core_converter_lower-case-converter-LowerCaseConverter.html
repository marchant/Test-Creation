...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: LowerCaseConverter</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: LowerCaseConverter</h1>
...
<header>
        ...
        <h2>
            <span class="ancestors"><a href="module-montage_core_converter_lower-case-converter.html">montage/core/converter/lower-case-converter</a>~</span>
        
        LowerCaseConverter
        </h2>
        
            <div class="class-description">Converts a string to lowercase.</div>
...
<article>
    ...
    <h4 class="name" id="LowerCaseConverter"><span class="type-signature"></span>new LowerCaseConverter<span class="signature">()</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="core_converter_lower-case-converter.js.html">core/converter/lower-case-converter.js</a>, <a href="core_converter_lower-case-converter.js.html#line10">line 10</a>
    </li></ul></dd>
